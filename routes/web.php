...
Route::get('/', [DonationController::class, 'showDonationCounter']);
...
Route::get('/chain-link/{chain}', [DonationController::class, 'showChain'])->name('show-chain');
...
Route::group(['middleware' => ['disable_back']], function () {
    Route::group(['middleware' => ['islogin']], function () {
        Route::group(['middleware' => ['users']], function () {
            ...
            Route::get('/brain', [PaymentController::class, 'checkout'])->name('brain');
