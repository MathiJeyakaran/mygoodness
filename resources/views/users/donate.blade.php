...
#submitForm:hover, .click-search:hover {
    background: #FFB900;
}
#submitForm:hover{
    color: #fff;
    ...
    <body class="yellowbg white">
        ...
        <section>
            ...
            <form id="myForm" method="POST" action="{{ url('continue') }}" enctype="multipart/form-data">
                <div class="p-text text-center p-2">Margaret gave a donation to <br> Nonprofit...give there too or <br> choose your own adventure.
                </div>
                @csrf
                ...
                <div class="fulwidth margiboxed">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="text-left search-drop" style="padding-left: 3px;">Or, search for a different nonprofit
                            ...
                            <div class="form-group has-search mb-2">
                                ...
                                {{-- <input type="text" id="org" name="org" class="form-control" placeholder="Search"> --}}
                                <select class="form-control ct" id="org" name="org" placeholder="" required>

                                </select>
                                <button class="click-search btn">
                                    <img src="images/5-2-arrow-transparent.png" alt="" style="width: 20px;height: 20px;">
                                </button>
                            </div> <br>
                            <div class="form-group">
                    ...
                    <div class="col-sm-12 givebox" style="margin-top: 40px;margin-bottom: 29px;">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary btn-margin active">
                              <input type="radio" name="amount" value="10" id="option1" autocomplete="off" checked> $10
                            </label>
                            <label class="btn btn-secondary btn-margin">
                              <input type="radio" name="amount" value="20" id="option2" autocomplete="off"> $20
                            </label>
                            <label class="btn btn-secondary btn-margin">
                                <input type="radio" name="amount" value="50" id="option3" autocomplete="off"> $50
                              </label>
                              <label class="btn btn-secondary btn-margin">
                                <input type="radio" name="amount" value="100" id="option4" autocomplete="off"> $100
                              </label>
                              <label class="btn btn-secondary btn-margin">
                                <input type="radio" name="amount" value="200" id="option5" autocomplete="off"> $200
                              </label>
                          </div>
                    </div>
                    ...
                    <div class="col-sm-12 pt-4">
                        ...
                        <div class="col-sm-12 pt-2 text-justify" style="font-family: Barlow;font-style: italic;font-size: 16px;line-height: 22px;font-weight: 500;">
                           <strong> mygoodness is a nonprofit too.</strong> A contribution is added to cover payment processing fees and to support the development of donor tools like this.
                           </div>
                            ...
                            success: function(data)
                                {
                                    ...
                                    // $('#orgein').attr('style','display: block');
                            ...
                            success: function(data)
                                {
                                    ...
                                    //      data: {
                                    //          org:orgein,
                                    //          charity_name:organizations.name,
                                    //          charity_logo:organizations.logoUrl,
