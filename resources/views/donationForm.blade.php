...
<body>
    <div class="jumbotron">
        <form action="https://www.sandbox.paypal.com/donate" method="post">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 offset-md-4">
                    ...
                    <input type="text" class="form-control" name="business" value="my.goodness.dev@gmail.com" />

                    <label for="">Item Name</label>
                    <input type="text" class="form-control" name="item_name" value="NGO" />

                    <label for="">Currency Code</label>
                    <input type="text" class="form-control" name="currency_code" value="USD" />
                    
                    <label for="">Notify URL</label>
                    <input type='text' class="form-control" name='notify_url' value='{{ route("notify") }}'>

                    <label for="">Cancel Return URL</label>
                    <input type='text' class="form-control" name='cancel_return' value='{{ route("error") }}'>

                    <label for="">Return</label>
                    <input type='text' class="form-control" name='return' value='{{ route("success") }}'>
